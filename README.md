...
example, if the user is opening the app in San Francisco, not only will San Francisco's current weather be shown, but also a randomly selected image from near the exact longitude and latitude of the user. That
